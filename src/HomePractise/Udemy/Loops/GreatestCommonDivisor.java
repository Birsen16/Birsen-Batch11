...
public class GreatestCommonDivisor {
    public static void main(String[] args) {
       // System.out.println(getGreatestCommonDivisor(30,40));
        Scanner scn = new Scanner(System.in);
        System.out.print("please enter 2 integer");
        int num1 = scn.nextInt();
        int num2 = scn.nextInt();
            int greatestDivisor=0;
        for (int divisor = 1; divisor<num1;divisor++){
            //bolen 1 ile basliyor,vea artiyor.;bolen ilk verilen rakamdan kucuk olmiyacak
            if (num1%divisor==0 && num2 %divisor==0){
                greatestDivisor=divisor;
                //iki sayiyida boluyouo

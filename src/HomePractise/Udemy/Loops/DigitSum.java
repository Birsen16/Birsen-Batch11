...
public class DigitSum {
    public static void main(String[] args) {
        System.out.println("Sum of the digits of 123 is = " + digitSum(123));
        System.out.println("Sum of the digits of 123 is = " + digitSum(9));
    }
...
The numbers from 0-9 have 1 digit so we donÅft want to process them, also we donÅft

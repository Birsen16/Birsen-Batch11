...
public class Methods4 {
    public static void main(String[] args) {
        ...
        //Contains();  it will  if the string has given value or not, returns true or false.
       boolean result1 = text.contains("le");//true
        System.out.println(result1);
        System.out.println(text.contains("t"));//false
        System.out.println(text.contains("selinium"));//false because it is lowercase s
        System.out.println(text.contains("1"));//false
        System.out.println(text.contains("lev"));//false


        //equals(); it will check if the given string has exactly same order if char. will return trie/false
        //Checks same char in exactly same order
        ...
        String text2 ="Java";
        System.out.println(text.equalsIgnoreCase(text2));//false  Selenium ---> Java     false

...
import pages.amazonages.AmazonSignUpPage;
...
public class AmazonSignUpSteps {
    ...
    public void the_user_provides_the_information(DataTable dataTable) {
       ...
       amazonSignUpPage.allInformation(allInformationFromDataTable.get(0),allInformationFromDataTable.get(1),allInformationFromDataTable.get(2),allInformationFromDataTable.get(3));
    }

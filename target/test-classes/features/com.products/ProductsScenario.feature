  ...
  Feature: Validation of Products
    ...
    Scenario: Validation of New Product Creation
      ...
      And the user enters the card information "Visa","1234567812345678","08/24"
      Then the user validates success message
      And the user validates product details "Techtorial","MyMoney","4","2200 E Devon","Des Plaines","IL","60018","Visa","1234567812345678","08/24"
    ...
    Scenario Outline: Validation of New Product Creation
      ...
      Examples:
        ...
        | ScreenSaver | 7        | Dino         | 43 dino adress | Schamburg   | TX    | 63434   | American Express | 546456456546 | 02/13      |
        | MyMoney     | 4        | Techtorial   | 2200 E Devon   | Des Plaines | IL    | 60018   | Visa             | 142342342342 | 08/24      |
        | FamilyAlbu | 6        | ahmet        | 560 michigan   | Michicagaon | MO    | 60432   | MasterCard       | 545345345345 | 05/12      |
        | ScreenSave | 7        | Dino         | 43 dino adress | Schamburg   | TX    | 63434   | American Express | 546456456546 | 02/13      |

        #FamilyAlbum
        #ScreenSaver    those are correct keys for last 2